...
export const clients: Client[] = [
  ...
  { name: 'Riviera Resort Hotel', logo: '/logos/riviera-resort.png' },
  { name: 'Portopiccolo Apartments', logo: '/logos/portopiccolo-apartments.webp' },
  { name: 'Hotel Miramare',       logo: '/logos/hotel-miramare.png' },
  { name: '3R Technology',        logo: '/logos/3r-technology.png',      lightSurface: true },
  { name: 'Neura',                logo: '/logos/neura.png',               noFilter: true },
  { name: 'MgGrill',              logo: '/logos/mggrill.png', noFilter: true },
  ...
  { name: 'Geom. Mauro Poles',    logo: '/logos/poles.png',              lightSurface: true },
  { name: 'Living Door',          logo: '/logos/livingdoor.png' },
  { name: 'Barcolana',            logo: '/logos/barcolana.png',          noFilter: true, lightSurface: true },
  ...
  { name: 'Il Salotto',           logo: '/logos/salotto.png',            lightSurface: true },
  { name: 'Embassy' },
  { name: 'VIP Motors',           logo: '/logos/vip-motors.png' },
  { name: 'NoleggioBar' },
  { name: 'Tubaro & Co.',         logo: '/logos/tubaro.png' },
  { name: 'Zanutta',              logo: '/logos/zanutta.png',            noFilter: true, lightSurface: true },
  { name: 'G&M Ambiente',         logo: '/logos/gm-ambiente.png' },
  { name: 'Reginato Srl',         logo: '/logos/reginato.png',           noFilter: true },
  { name: 'Ennevi Costruzioni',   logo: '/logos/ennevi.png',             noFilter: true, lightSurface: true },
  { name: 'Dolfo Srl',            logo: '/logos/dolfo.png' },
  { name: 'Hotel Elite',          logo: '/logos/hotel-elite.png',        lightSurface: true },
  { name: 'Garden Hotel Michelangelo', logo: '/logos/hotel-michelangelo.png', lightSurface: true },
  { name: 'Banshi' },
  ...
  { name: 'Élite SPA' },
  { name: 'La Busa del Sauc',     logo: '/logos/busa-del-sauc.png',      lightSurface: true },
  { name: 'Casa Rossa' },
