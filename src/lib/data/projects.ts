...
export const clients: Client[] = [
  { name: 'Ricci Group',          href: '/progetti/ricci-group',         logo: '/logos/ricci-group.webp' },
  ...
  { name: 'Scuola Sci Piancavallo', href: '/progetti/scuola-sci-piancavallo', logo: '/logos/scuola-sci-piancavallo.png' },
